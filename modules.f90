module dimensions
    ...
    integer,parameter::sims=10,sims_tr=10 !20,sims_tr=200 sims needs to be smaller than sims_tr
end
...
module primitives
    ...
    !area of plots
    double precision,dimension(types_a)::area=(/1.0d0,2.0d0,3.0d0,5.1d0/) !(/1.3d0,4.0d0/) 
    double precision,dimension(types_a-1)::area_lims=(/1.3d0,2.3d0,4.0d0/)!(/2.3d0/) 
    !wealth quantiles
...
use cadastral_maps
    ...
    integer::it_est=1,generate_data=1
