subroutine compute_eq_F_CCP(params,F,CCP,V_fct_ts,V_social,n_initial,v_l,mean_N,social_output,private_output,joint_pr,pr_d_a_n,pr_N_n,pr_na)
    ...
    do a_l=1,types_a;do u_l=1,unobs_types
        call expected_productivity((/params(2),params(1),params(7)/),area(a_l),Ef_v(:,:,:,a_l,v_l,u_l),v_l,u_l) !Ef_v(1,:,1,1,1,1)
